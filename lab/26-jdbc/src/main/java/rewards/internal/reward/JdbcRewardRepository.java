...
// -08 (Optional) : Inject JdbcTemplate directly to this repository class
...
// -03: Refactor the cumbersome JDBC code in JdbcRewardRepository with JdbcTemplate.
...
public class JdbcRewardRepository implements RewardRepository {
    ...
    public JdbcRewardRepository(final JdbcTemplate jdbcTemplate) {
    ...
    public RewardConfirmation confirmReward(final AccountContribution contribution, final Dining dining) {
        ...
        final String confirmationNumber = this.nextConfirmationNumber();
        ...
        this.jdbcTemplate.update(sql, confirmationNumber, contribution.getAmount().asBigDecimal(),
