 ...
 * data source.
 *
 * Besides helping catch bugs early, tests are a great way for a new developer to learn an API as he
 * or she can see the API in action. Tests also help validate a design as they are a measure for how
 * easy it is to use your code.
 */
public class RewardNetworkImplTests {
    ...
    public void setUp() throws Exception {
        ...
        final AccountRepository accountRepo = new StubAccountRepository();
        final RestaurantRepository restaurantRepo = new StubRestaurantRepository();
        final RewardRepository rewardRepo = new StubRewardRepository();

        // setup the object being tested by handing what it needs to work
        this.rewardNetwork = new RewardNetworkImpl(accountRepo, restaurantRepo, rewardRepo);
    }

    // 03: Test RewardNetworkImpl class
