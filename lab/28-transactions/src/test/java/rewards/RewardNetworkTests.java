 ...
 * environment.
 *
 * -04: Save all work, run this RewardNetworkTests below. It should pass. (If you are using Gradle,
 * remove all exclude statements from the build.gradle file before running the test.) - Notice that
 * we have enabled DEBUG logging in setup() below. - Check the logging output. Is only ONE
...
public class RewardNetworkTests {
    ...
    public void setup() {
        ...
        final Logger jdbcLogger = (Logger) LoggerFactory
    ...
    public void testRewardForDining() {
        ...
        final String sql = "SELECT COUNT(*) FROM T_REWARD WHERE CONFIRMATION_NUMBER = ? AND REWARD_AMOUNT = ?";
        final int count = this.jdbcTemplate.queryForObject(sql, Integer.class, confirmation.getConfirmationNumber(),
